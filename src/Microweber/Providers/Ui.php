...
class Ui
{
    ...
    {
        $this->admin_logo_login = mw_includes_url().'images/logo-login.png';
        $this->admin_logo = mw_includes_url().'images/Dashboard.png';
		$this->logo_live_edit = mw_includes_url().'images/logo.png';
        $this->defaults();
    }
