  ...
  <style scoped="scoped">
    ...
    $(mwd).ready(function(){
      ...
      <nav class="mw-ui-btn-nav mw-ui-btn-nav-tabs">
        ...
        <a class="mw-ui-btn" href="javascript:;"><?php _e("Images");?></a>
