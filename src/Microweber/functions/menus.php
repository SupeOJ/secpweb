...
function get_pdf($params,$contentps)
{
    return mw()->menu_manager->get_pdf($params,$contentps);
}

api_expose_admin('get_pdfid');
function get_pdfid($id)
{
    return mw()->menu_manager->get_pdfid($id);
}
...
api_expose_admin('sliderbar_item_delete');
function sliderbar_item_delete($id)
{
    return mw()->sliderbar_manager->sliderbar_item_delete($id);
}
api_expose_admin('sliderbar_item_create');
function sliderbar_item_create($data_to_save)
{
    //print_r($data_to_save);exit;
    return mw()->sliderbar_manager->sliderbar_item_create($data_to_save);
}
api_expose_admin('sliderbar_item_get');
function sliderbar_item_get($id)
{   
    return mw()->sliderbar_manager->sliderbar_item_get($id);
}
