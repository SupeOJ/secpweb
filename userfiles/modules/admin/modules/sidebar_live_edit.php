<div id="modules-and-layouts-sidebar" class="modules-and-layouts-holder mw-normalize-css">
    ...
    <h3 class="tab-title tab-title-0">添加布局</h3>
    <h3 class="tab-title tab-title-1" style="display: none;">添加模块</h3>
    <h3 class="tab-title tab-title-2" style="display: none;">设置</h3>

    <div id="mw-modules-layouts-tabsnav">
        <div class="mw-ui-btn-nav mw-ui-btn-nav-tabs">
            <a href="javascript:;" class="mw-ui-btn tabnav active"><i class="mwi-desktop-plus"></i> 布局</a>
            <a href="javascript:;" class="mw-ui-btn tabnav"><i class="mwi-folder"></i> 模块</a>
            <a href="javascript:;" class="mw-ui-btn tabnav"><i class="mwi-cog"></i> 设置</a>
        </div>
        ...
        <div id="search-modules-and-layouts" class="">
            ...
            <div class="tab-title tab-title-0 layouts">
                <div class="search-wrapper">
                    <label for="search-input">
                        <i class="mw-icon-search" aria-hidden="true" style='margin-top: -20px;'></i>
                    </label>

                    <input onkeyup="mwSidebarSearchItems(this.value, 'layouts')" class="form-control input-lg" placeholder="搜索布局"
                ...
                <p class="mw-search-no-results" style="margin: 35px 0 15px 0; display: none; text-align: center;">没有找到结果</p>
            </div>
            ...
            <div class="tab-title tab-title-1 modules" style="display: none;">
                <div class="search-wrapper">
                    ...
                    <input onkeyup="mwSidebarSearchItems(this.value, 'modules')" class="form-control input-lg" placeholder="搜索模块"
                           autocomplete="off" spellcheck="false" autocorrect="off" tabindex="1"
                           data-id="mw-sidebar-search-input-for-modules-and-layouts">
