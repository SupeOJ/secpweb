...
<label class="mw-ui-label"><?php _e('Set your skills') ?></label>
    ...
    <?php foreach($skills as $skill){ ?>
        <span class="skillfield">
            ...
            <div class="mw-ui-field-holder mufh-1">
              <label class="mw-ui-label"><?php _e('Skill Name') ?></label>
              <input type="text" autocomplete="off"  value="<?php print $skill['skill']; ?>" placeholder="<?php _e('Insert skill Name') ?>" class="mw-ui-field skill" />
            </div>
            ...
            <div class="mw-ui-field-holder mufh-3">
              ...
              <select class="mw-ui-field" data-value="<?php print isset($skill['style']) ? $skill['style'] : 'primary' ?>">
                <option value=""><?php _e('Choose Style') ?></option>
                <option value="primary"><?php _e('Primary') ?></option>
                <option value="warning"><?php _e('Warning') ?></option>
                <option value="danger"><?php _e('Danger') ?></option>
...
<span class="mw-ui-btn w100" onclick="addNewskill();"><span class="mw-icon-plus"></span> <?php _e('Add More') ?></span>
