...
__mw_pics_save_msg = function(){
	 ...
	 if(mw.notification != undefined){
			 mw.notification.success('图片设置已经保存！');
	 }
...
.tab{
 ...
 <?php if($quick_add == false and $use_from_post_forced == false): ?>
  <!--<label class="mw-ui-check" id="mw-pic-scope">
      <input type="checkbox" reload="#mw-pics-list-live-ed" id="mw-use-post-pics" name="data-use-from-post" value="y" class="mw_option_field" <?php if( $use_from_post): ?>   checked="checked"  <?php endif; ?> /></label>  -->
     <?php endif; ?>
