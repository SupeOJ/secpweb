...
<form id="add-testimonial-form">
    ...
    <div class="mw-ui-field-holder">
        ...
        <input type="text" name="name" placeholder="名称" value="<?php print $data['name'] ?>" class="mw-ui-field w100">
    </div>
    ...
    <div class="mw-popup-footer">
        <div class="mw-popup-footer-content">
            <input type="submit" name="submit" value="保存" class="mw-ui-btn mw-ui-btn-invert pull-right"/>
        </div>
    </div>
</form>
