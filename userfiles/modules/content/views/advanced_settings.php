        ...
        <div class="mw-ui-col">
            <div class="mw-ui-col-container">
                <div class="mw-ui-field-holder">
                    <label class="mw-ui-label">
                        <?php _e("Description"); ?>
                        <small class="mw-help mw-help-right-bottom" data-help=" <?php _e("Short description for yor content."); ?>">(?)
                        </small>
                    </label>
                    <textarea
                ...
                <div class="mw-ui-field-holder">
                    <label class="mw-ui-label">
                        <?php _e("Meta Title"); ?>
                        <small class="mw-help"
                               data-help="该产品的名称将出现在社交网络的搜索引擎上。">
                            (?)
                        </small>
                    </label>
                ...
                <div class="mw-ui-field-holder">
                    <label class="mw-ui-label">
                        ...
                        <small class="mw-help"
                               data-help="这个产品的关键词，将有助于搜索引擎找到它。例如: ipad, 书">
                            (?)
                        </small>
                    </label>
