<div class="module-live-edit-settings">
    <span class="mw-ui-btn mw-ui-btn-invert pull-right" onclick="Bxslider.create();"><?php _e('Add new slide');?></span>

    <h2><?php _e('bxSlider - Settings');?></h2>
        ...
        foreach ($json as $slide) {
            ...
            <div class="mw-ui-box  bxslider-setting-item" data-skin="<?php print $slide['skin']; ?>">
                <div class="mw-ui-box-header" onclick="mw.accordion(this.parentNode);">
                    ...
                    <span class="mw-icon-gear"></span> <?php _e("Slide"); ?> <?php print $count; ?>
                </div>
                ...
                <div class="mw-ui-box-content mw-accordion-content" style="display: none;">
                    <div class="mw-ui-row-nodrop">
                        ...
                        <div class="mw-ui-col">
                            <div class="mw-ui-col-container">
                                ...
                                <input type="text" class="mw-ui-field bxslider-main-text w100 " value="<?php print _e($slide['primaryText']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="mw-ui-col">
                            <div class="mw-ui-col-container">
                                ...
                                <input type="text" class="mw-ui-field bxslider-secondary-text w100" value="<?php print _e($slide['secondaryText']); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mw-ui-field-holder">
                        ...
                        <input type="text" class="mw-ui-field bxslider-seemore" value="<?php print _e($slide['seemoreText']); ?>">
                    </div>
                    ...
                    <div class="bxslider-images">
                        ...
                        <span class="mw-ui-btn mw-ui-btn-invert bxslider-uploader"><span class="mw-icon-upload"></span><?php _e('Add Image');?></span>
                    </div>
                </div>
            </div>
        <?php } ?>
