...
<label class="mw-ui-label"><?php _e("Add Images"); ?> 或
	...
	<div class="select_actions">
		<div class="mw-ui-btn-nav select_actions">
			<a href="javascript:;" class="mw-ui-btn mw-ui-btn-small mw-ui-btn-important mw-ui-btn-icon" onclick="deleteSelected()">
					<span class="mw-icon-bin tip" data-tip="<?php _e('Delete') ?>" data-tipposition="top-right"></span>
			</a>
			<a href="javascript:;" class="mw-ui-btn mw-ui-btn-small mw-ui-btn-icon" onclick="downloadSelected('none')">
				<span class="mw-icon-download tip" data-tip="<?php _e('Download') ?>" data-tipposition="top-right"></span>
			</a>
		</div>
	</div>
	<span class="btnnv-label"><?php _e("Select");?></span>
	<div class="mw-ui-btn-nav">
		<a href="javascript:;" class="mw-ui-btn mw-ui-btn-small" onclick="selectItems('all')"><?php _e("All");?></a>
		<a href="javascript:;" class="mw-ui-btn mw-ui-btn-small" onclick="selectItems('none')"><?php _e("None");?></a>
	</div>
</div>
		...
		<div class="mw-ui-field-holder">
			...
			<div id="image-json-options-<?php print  $item['id']; ?>">
				<div class="image-json-options">
					<?php
					 ...
					 $curr = isset($item['image_options']) ? $item['image_options'] : array();
						...
						foreach($init_image_options as $name){    ?>
							...
							<div class="mw-ui-field-holder">
								<label class="mw-ui-label"><?php print _e($name); ?></label>
					...
					<span class="mw-ui-btn pull-left" onclick="imageConfigDialogInstance.remove()"><?php _e('Cancel');?></span>
					<span class="mw-ui-btn mw-ui-btn-notification pull-right" onclick="saveOptions(<?php print $item['id']  ?>);imageConfigDialogInstance.remove()"><?php _e('Updates') ?></span>
