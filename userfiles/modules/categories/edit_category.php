...
$(document).ready(function(){
    ...
    <?php endif; ?>
	 ...
	 mw.$('#admin_edit_category_form_<?php print $form_rand_id ?>').submit(function() {
		 ...
		 mw.notification.success("保存...",3000);
         ...
         mw.form.post(mw.$('#admin_edit_category_form_<?php print $form_rand_id ?>') , '<?php print api_link('category/save') ?>', function(val){
            ...
            mw.$('#mw-notifications-holder').empty();
        	  mw.notification.success("保存类别更改");
 			  var v = this.toString();
    ...
    <div class="mw-ui-field-holder">
      <div class="mw-ui-row-nodrop valign" id="content-title-field-row">
        ...
        <div class="mw-ui-col">
          ...
          <?php endif; ?>
          <input  class="mw-ui-invisible-field mw-ui-field-big" id="content-title-field" name="title" type="text" <?php if($data['id'] == 0){ ?>placeholder<?php } else{ ?>value<?php } ?>="<?php print _e(($data['title'])); ?>" />
          <?php endif; ?>
        </div>
