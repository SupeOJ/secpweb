...
<div id="mw-login">
    ...
    <div id="login_foot"><a href="<?php print site_url() ?>" class="pull-left"><span class="mw-icon-back"></span>
		...
		&nbsp;&nbsp;<a href="javascript:mw.load_module('users/forgot_password', '#admin_login', false, {template:'admin'});" class="mw-ui-link pull-right">
             <?php _e("Forgot my password"); ?>
            </a>
    <?php $curent_val = get_option('enable_user_registration', 'users'); ?>
			<?php if ($curent_val == 'y'): ?>
			<a href="javascript:mw.load_module('users/register', '#admin_login', false, {template:'admin'});" class="mw-ui-link pull-reg pull-register">
             注册
            </a>
			<?php endif; ?>
			<a href="javascript:history.back(-1);" class="mw-ui-link pull-reg pull-login">
             登录
            </a></div>
<?php endif; ?>
</div>
