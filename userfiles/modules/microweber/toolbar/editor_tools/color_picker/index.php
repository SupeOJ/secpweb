...
<script type="text/javascript">
    ...
    _color_prompt = function(){
        ...
        var input = mwd.getElementById('colorpicker');
        var color = prompt("请输入颜色值", input.value);
        if (color != null) {
...
<div id="main_holder">
    ...
    <label class="mw-ui-label"><?php _e("Custom color"); ?> <a href="javascript:_color_prompt()" id="hex_color_value" style="padding:10px;">#</a></label>
