...
?>
<?php if(in_live_edit()){$height1 = $height+40;}else{$height1 = $height;}?>
<script>
...
<div style="<?php if(in_live_edit()):?>position: relative;height: <?php echo $height1;?>px;<?php endif;?>" >
   <iframe style="height:<?php echo $height;?>px;width: <?php echo $width;?>%;background-color:#00000094;" src='<?php echo $ifmUrl;?>'></iframe>      
</div>
</section>