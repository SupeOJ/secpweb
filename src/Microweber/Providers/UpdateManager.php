...
//        }
    ...
    public function validate_license($params = false)
    {
        ...
        if (!empty($lic_ids)) {
            return array('updates' => $lic_ids, 'success' => _e('Licenses are checked'));
        }
    }
    ...
    public function save_license($params)
    {
        ...
        return array('id' => $r, 'success' => _e('License key saved'));
    }
...
//                                $file_utils->rmdir($vendor_orig_sub_folder);
        ...
        if ($out == 2) {
            return array('error' => _e('Error resolving Composer dependencies'));
        } elseif ($out == 1) {
            return array('error' => _e('Composer has an unknown error'));
        } elseif ($out === 0) {
