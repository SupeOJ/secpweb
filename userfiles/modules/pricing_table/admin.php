                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-xs-8">
                            <select name="style_color" data-refresh="pricing_table" class="form-control mw_option_field" id="style_color">
                                <option value="bg-primary" style="background:#4c6972;"<?php print $style_1; ?>><?php _e('Primary');?></option>
                                <option value="bg-success" style="background:#7ac673;" <?php print $style_2; ?>><?php _e('Success');?></option>
                                <option value="bg-info" style="background:#27aae0;" <?php print $style_3; ?>><?php _e('Info');?></option>
                                <option value="bg-warning" style="background:#faaf40;" <?php print $style_4; ?>><?php _e('Warning');?></option>
                                <option value="bg-danger" style="background:#f97352;" <?php print $style_5; ?>><?php _e('Danger');?></option>
                            </select>
                        </div>
                    </div>
                </div>
