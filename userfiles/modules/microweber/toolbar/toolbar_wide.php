    ...
    <div id="mw-text-editor" class="mw-defaults mw_editor">
      <div class="toolbar-sections-tabs">
        ...
        <ul>
          ...
          <li class="create-content-dropdown mw-toolbar-btn-menu"> <a href="javascript:;" class="mw-ui-btn mw-ui-btn-medium" title="<?php _e('Create or manage your content') ?>" style=""> <span class="ico iplus"></span> <?php _e('Add New'); ?> </a>
