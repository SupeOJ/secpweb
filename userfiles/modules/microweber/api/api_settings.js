...
mw.settings = {
    ...
    handles: {
        ...
        <div contenteditable='false' id='mw_handle_module' class='mw-defaults mw_master_handle mw-sorthandle mw-sorthandle-col mw-sorthandle-module' draggable='false'>\
            ...
            <a title='单击以编辑此模块.' class='mw_edit_settings' href='javascript:void(0);' onclick='mw.drag.module_settings();return false;' draggable='false'><span class='mw-element-name-handle' draggable='false'></span></a>\
            ...
            <span title='单击以选择此模块' class='mw-sorthandle-moveit' draggable='false' title='<?php _e("Move"); ?>'></span>\
        </div>",
        row: "\
        <div contenteditable='false' class='mw-defaults mw_master_handle mw_handle_row' id='mw_handle_row' draggable='false'>\
            <span title='单击以选择此列.' class='column_separator_title'><?php _e("Columns"); ?></span>\
        ...
        item: "<div title='单击以选择此项.' class='mw_master_handle' id='items_handle'></div>"
    },
