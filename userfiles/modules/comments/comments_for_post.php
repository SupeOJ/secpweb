...
<?php if(!isset($params['no_post_head'])): ?>
  ...
  <div class="comments-show-btns"> <span class="mw-ui-btn comments-show-all" onclick="mw.adminComments.display(event,this, 'all');"><?php print ($count_old+$count_new); ?> <?php _e("All") ?></span>
    <?php if( $count_new > 0 ): ?>
