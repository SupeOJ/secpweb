...
?>
<div class="moduleAdmin-caHeader module-live-edit-settings">
    ...
    <div class="mw-ui-row-nodrop">
        <div class="mw-ui-col">
            <div class="mw-ui-col-container">
                <div class="mw-ui-field-holder">
                    <label class="mw-ui-check">
                        <input type="checkbox" name="showBtns" value="y" class="mw_option_field" <?php if($showBtns=='y'){ print 'checked="checked"';} ?> />
                        <span></span>
                        <span> 显示按钮</span>
                    </label>
                </div>
        ...
        <div class="mw-ui-col">
            <div class="mw-ui-col-container">
                <div class="mw-ui-field-holder">
                    <label class="mw-ui-check">
                        <input type="checkbox" name="showArrow" value="y" class="mw_option_field" <?php if($showArrow=='y'){ print 'checked="checked"';} ?> />
                        <span></span>
                        <span> 显示箭头</span>
                    </label>
                </div>
    ...
    <div class="mw-ui-field-holder">
        <label class="mw-ui-label">内容对齐方式</label>
        <select class="mw-ui-field mw_option_field w100" id="contentAlign" name="contentAlign">
            <option <?php if($contentAlign=='left'){ print 'selected'; } ?> value="left">靠左</option>
            <option <?php if($contentAlign=='center'){ print 'selected'; } ?> value="center">居中</option>
            <option <?php if($contentAlign=='right'){ print 'selected'; } ?> value="right">靠右</option>
        </select>
    </div>
     <div class="mw-ui-field-holder">
        ...
        <select class="mw-ui-field mw_option_field w100" id="bground" name="bground">
            ...
            <option <?php if($bground=='video'){ print 'selected'; } ?> value="video">视频</option>
        </select>
    </div>
    ...
    <div id="moduleAdmin_caHeader_bgVedio" style="display:none;">
        <label class="mw-ui-label">视频地址（目前仅支持YouTube链接）</label>
        <input type="text" name="bgVedio" class="mw_option_field mw-ui-field w100" value="<?php print $bgVedio; ?>" placeholder="请输入视频地址" />
    </div>
