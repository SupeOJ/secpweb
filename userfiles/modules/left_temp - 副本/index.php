...
<script type="text/javascript">
	  ...
	  $('.add_sig').on('click','.ecp_pdf>.add_pdf',function(){
        ...
        <?php }else{ ?>
		    if(Hf){
				  ...
				  $('#InlineFrame1').css('height','1018px');
				  return false;
			}
        <?php } ?>
   ...
   var times_s = 1;
    function showClick(){
		   times_s++;
			   $('#PanelMenu1_panel').animate({'left':'-270px'},200,"linear");
			   $('.photon-default').animate({'margin-left':'0px'},200,"linear");
		   if(times_s%2==0){
...
<div id="mw-sliderbarMenu-module-<?php print $params['id']; ?>" style="<?php echo $background;?>;height:0px;">
    <!--<头部>-->
   <iframe name="InlineFrame1" id="InlineFrame1" style="width:100%;height:0px;z-index:100;" src=''></iframe>
    ...
    <a href="#PanelMenu1_markup" id="PanelMenu1" class="Panpic1"></a>
      ...
      <ul class="menuli ecp_web edit" data-field="<?php echo $params['id'];?>-menu1" rel="<?php echo $params['id'];?>">
			 <li><img src="<?php print $config['url_to_module']; ?>./img/zwy.png">政务云平台 <i></i></li>
			 <li><img src="<?php print $config['url_to_module']; ?>./img/ypt.png">企业云平台 <i></i></li>
			 <li><img src="<?php print $config['url_to_module']; ?>./img/wlw.png">务联网桌面  <i></i> </li>
			 <li><img src="<?php print $config['url_to_module']; ?>./img/bi.png">BI智慧系统 <i></i> </li>
      </ul>
          <?php if(in_live_edit()):?>
    ...
    <div id="wb_PanelMenu2" style="position:fixed;right:-279px;top:0px;width:279px;height:100%;z-index:100;    background: #262626;" >
      <a href="#PanelMenu2_markup" id="PanelMenu2">
            <div class="right-nav-button" onclick="showClick()" style="margin: 17px 18px;">
                <div >
                    <div class="bar"></div>
                    <div class="bar"></div>
                    <div class="bar"></div>
      ...
      <ul class="menuli ecp_menu edit" id="right-nav" data-field="<?php echo $params['id'];?>-imgg" data-id="<?php echo $params['id'];?>" rel="<?php echo $params['id'];?>">
         ...
         <div class="add_sig"><div class="ecp_pdf">
          ...
          <?php endif;?>
			 <div class="ppdf"></div>
	   <div class="move_pdf">
		  <iframe class="pdf_if" src="" style="height:1000px;width:1000px;border:0px;"></iframe>
	   </div>
      </div>
    </div>
