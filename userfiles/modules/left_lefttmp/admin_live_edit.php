...
<?php  
  ...
  if($menu_name == false and isset($params['menu_name'])){
	  $menu_name = $params['menu_name'];var_dump($menu_name);echo 1;exit;
  } elseif($menu_name == false and isset($params['menu-name'])){
	  $menu_name = $params['menu-name'];var_dump($menu_name);echo 12;exit;
  }elseif($menu_name == false and isset($params['name'])){
	  $menu_name = $params['name'];var_dump($menu_name);echo 132;exit;
  }

//var_dump($menu_name);echo 88;exit;
