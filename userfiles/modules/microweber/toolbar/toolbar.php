                ...
                <div class="toolbar-sections-tabs">
                    <ul>
                        <li class="create-content-dropdown">
                            <a href="javascript:;" class="tst-logo" title="SECPWEB">
                                ...
                                <span class="mw-icon-dropdown"style="top:0px;"></span>
                            </a>
                        ...
                        <li class="create-content-dropdown mw-toolbar-btn-menu">
                            ...
                            <a href="javascript:;" class="mw-ui-btn mw-ui-btn-medium mw-dropdown-button mw-toolbar-add-new-content-ctrl" title="<?php _e('Create or manage your content') ?>"
